    ...
    return function (__copy_dictEuclideanRing) {
        return function (__copy_a) {
            return function (__copy_b) {
                ...
                var b = __copy_b;
                tco: while (true) {
                    var $7 = Data_Eq.eq(dictEq)(b)(Data_Semiring.zero(((dictEuclideanRing["__superclass_Data.CommutativeRing.CommutativeRing_0"]())["__superclass_Data.Ring.Ring_0"]())["__superclass_Data.Semiring.Semiring_0"]()));
                    if ($7) {
                        return a;
                    };
                    if (!$7) {
                    ...
                    throw new Error("Failed pattern match at Data.EuclideanRing line 74, column 3 - line 76, column 27: " + [ $7.constructor.name ]);
                };
            };
        };
    };
    ...
    return function (dictEuclideanRing) {
        return function (a) {
            return function (b) {
                ...
                throw new Error("Failed pattern match at Data.EuclideanRing line 81, column 3 - line 83, column 24: " + [ $8.constructor.name ]);
            };
        };
    };
};
...
},{"../Data.BooleanAlgebra":14,"../Data.CommutativeRing":17,"../Data.Eq":19,"../Data.HeytingAlgebra":27,"../Data.Ring":35,"../Data.Semiring":39,"./foreign":20}],22:[function(require,module,exports){
// Generated by psc version 0.10.7
"use strict";
var Data_CommutativeRing = require("../Data.CommutativeRing");
